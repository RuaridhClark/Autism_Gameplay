...
%         
%         score = tab_sev.additional_patient_data__mood(i);%tab_sev.recording_day_data__distractibility(i);%tab_sev.recording_day_data__interest_in_tablet_games(i);%tab_sev.additional_patient_data__exposure_to_tablets(i);%tab_sev.additional_patient_data__cooperativity(i);%tab_sev.additional_patient_data__arousal(i);%
