...
obj(4,1:4)=[19, 309, yl-523, yl-196];   % obj(4,1:4)=[101, 101+131, yl-400-96, yl-283];
obj(5,1:4)=[311, 531, yl-523, yl-196];    % obj(5,1:4)=[325,325+131, yl-400-96, yl-400];
obj(6,1:4)=[533,753, yl-523, yl-196];   % obj(6,1:4)=[551, 551+131, yl-400-96, yl-400];
obj(7,1:4)=[755, 1004, yl-523, yl-264];   % obj(7,1:4)=[776, 776+131, yl-400-96, yl-400];
...
%                     prev_n = nn;
    ...
    %% save adj
    save([file_adj,'adj_obj_end_snapto\',savename],'adj') 
